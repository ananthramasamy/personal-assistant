...
public class CircleIndicatorView extends View {
    ...
    private void init(Context context) {
        ...
        activeIndicatorPaint.setColor(ContextCompat.getColor(context, R.color.active_color));
        activeIndicatorPaint.setAntiAlias(true);
        inactiveIndicatorPaint = new Paint();
        inactiveIndicatorPaint.setColor(ContextCompat.getColor(context, R.color.in_active_color));
